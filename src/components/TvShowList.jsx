...
const TVShowList = () => {
  ...
  useEffect(() => {
    fetch(
      `https://api.themoviedb.org/3/tv/top_rated?api_key=88f67c5b1985c7abf2a685c57dd2e29d&language=en-US&page=${page}`
    )
  ...
  return (
    <div>
      ...
      <div className="pagination flex justify-center space-x-4 mt-4 mb-2">
        <button
          onClick={prevPage}
          className="bg-orange-300 hover:bg-orange-500 text-white font-bold py-2 px-6 rounded"
        >
          Previous
        </button>
        <button
